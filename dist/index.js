...
// ── 1. Health check ───────────────────────────────────────────────────────────
server.registerTool("cft_health", {
...
// ── 2. Market prices ──────────────────────────────────────────────────────────
server.registerTool("cft_market_prices", {
...
// ── 3. List deals ─────────────────────────────────────────────────────────────
server.registerTool("cft_list_deals", {
...
server.registerTool("cft_deal_stats", {
    ...
    const data = await api("/api/admin?summary=1");
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
});
// ── 5. WhatsApp sessions ──────────────────────────────────────────────────────
server.registerTool("cft_whatsapp_sessions", {
...
server.registerTool("cft_reset_whatsapp_session", {
...
server.registerTool("cft_update_deal_status", {
...
server.registerTool("cft_verify_certificate", {
...
server.registerTool("cft_calculate_fot", {
...
// ── 10. List suppliers ────────────────────────────────────────────────────────
server.registerTool("cft_list_suppliers", {
